...
/**
 * Binds the decorated service method as a handler for incoming Stripe Connect Webhook events.
 * Events will be automatically routed here based on their event type property
 * @param config The configuration for this handler
 */
export const StripeConnectWebhookHandler = (
  eventType: Stripe.WebhookEndpointCreateParams.EnabledEvent
) => SetMetadata(STRIPE_CONNECT_WEBHOOK_HANDLER, eventType);
